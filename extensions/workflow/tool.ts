...
const taskInput = Type.Object({
	key: Type.String({ maxLength: WORKFLOW_LIMITS.maxKey }),
	title: Type.Optional(Type.String({ maxLength: WORKFLOW_LIMITS.maxTitle, description: "Short imperative subject line (about 60 characters) shown in the task view; put longer detail in outcome" })),
	outcome: Type.String({ maxLength: WORKFLOW_LIMITS.maxOutcome }),
...
const amendmentChange = Type.Union([
	...
	Type.Object({ kind: Type.Literal("add_task"), key: Type.String({ maxLength: 64 }), title: Type.Optional(Type.String({ maxLength: WORKFLOW_LIMITS.maxTitle })), outcome: Type.String({ maxLength: WORKFLOW_LIMITS.maxOutcome }), covers: Type.Optional(Type.Array(Type.String())), dependsOn: Type.Optional(Type.Array(Type.String())), enablingPurpose: Type.Optional(Type.String({ maxLength: WORKFLOW_LIMITS.maxOutcome })), repositoryOwner: Type.Optional(Type.String()), writeSurface: Type.Optional(Type.Array(Type.String())), executionConstraints: Type.Optional(Type.Array(Type.String())) }, { additionalProperties: false }),
	...
	Type.Object({ kind: Type.Literal("split_task"), id: Type.String(), into: Type.Array(Type.Object({ key: Type.String({ maxLength: 64 }), title: Type.Optional(Type.String({ maxLength: WORKFLOW_LIMITS.maxTitle })), outcome: Type.String({ maxLength: WORKFLOW_LIMITS.maxOutcome }), covers: Type.Optional(Type.Array(Type.String())), dependsOn: Type.Optional(Type.Array(Type.String())) }, { additionalProperties: false }), { minItems: 1, maxItems: WORKFLOW_LIMITS.maxListItems }) }, { additionalProperties: false }),
	Type.Object({ kind: Type.Literal("merge_tasks"), ids: Type.Array(Type.String(), { minItems: 2, maxItems: WORKFLOW_LIMITS.maxListItems }), key: Type.String({ maxLength: 64 }), title: Type.Optional(Type.String({ maxLength: WORKFLOW_LIMITS.maxTitle })), outcome: Type.String({ maxLength: WORKFLOW_LIMITS.maxOutcome }), covers: Type.Optional(Type.Array(Type.String())), dependsOn: Type.Optional(Type.Array(Type.String())) }, { additionalProperties: false }),
	Type.Object({ kind: Type.Literal("replace_task"), id: Type.String(), key: Type.String({ maxLength: 64 }), title: Type.Optional(Type.String({ maxLength: WORKFLOW_LIMITS.maxTitle })), outcome: Type.String({ maxLength: WORKFLOW_LIMITS.maxOutcome }), covers: Type.Optional(Type.Array(Type.String())), dependsOn: Type.Optional(Type.Array(Type.String())) }, { additionalProperties: false }),
